...
public class CLValueTuple3 extends
        CLValueChildren<Triplet<? extends CLValue<?, ?>, ? extends CLValue<?, ?>, ? extends CLValue<?, ?>>, CLTypeTuple3> {
    ...
    public void decode(CLValueDecoder clvd)
        ...
        if (child3.getClType() instanceof CLTypeChildren) {
            ((CLTypeChildren) child3.getClType()).getChildTypes()
                    .addAll(((CLTypeChildren) clType.getChildTypes().get(2)).getChildTypes());
        }
        child3.decode(clvd);
